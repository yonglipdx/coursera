...
public:
    bool isPalindrome(string s) {
        transform(s.begin(), s.end(), s.begin(), ::tolower); // LD: to lower case in C++11.
        auto left = s.begin(), right = prev(s.end());        // LD: auto right = prev(s.end());
        while (left < right) {
            if (!::isalnum(*left))  ++left;                  // LD: skip white space: isalnum(*right);
